...
- [- https://goemon.cloud/t/aTzSoAnzDyQw1TOwPrPn を[タスクのコピー]により複製する] こちらはv7です
または、
- [jsPsych Survey Plugin関連ファイルのアップロード]を参考に新規タスクを作成し、関連ファイルをアップロードする - v8はsurvey.cssの取得方法が異なる
